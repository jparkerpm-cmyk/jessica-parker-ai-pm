...
- Platforms searched: Indeed, Dice, ZipRecruiter, Hiring Cafe, Wellfound
...
**Job search.** Search Indeed, Dice, ZipRecruiter, Hiring Cafe, and Wellfound for matching roles, filter, and evaluate the top candidates.
...
After a job search run, a results summary table collapses all scored results to one row each: company, role, platform, score, recommendation, salary signal, and the top reason. Decision-grade at a glance without re-reading five full reports.
...
<table>
  <tr>
    <td>1</td>
    <td>evaluate jd [paste JD text or URL]</td>
  </tr>
</table>
...
<table>
  <tr>
    <td>1</td>
    <td>outcome [company] applied</td>
  </tr>
    <tr>
    <td>2</td>
    <td>update [company] phone screen</td>
  </tr>
    <tr>
    <td>3</td>
    <td>outcome [company] rejected</td>
  </tr>
</table>
...
A general-purpose version with a separated engine and profile-building onboarding is on the roadmap. See DECISIONS.md for the rationale.
